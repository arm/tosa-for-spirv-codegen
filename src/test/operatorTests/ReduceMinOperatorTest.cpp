...
// TEST HASH 18371326620163743041
TEST(TOSA_FOR_SPIRV_CODEGEN_OPERATOR, ReduceMinOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::ReduceMin;
const std::vector<Attribute> inputs {{std::initializer_list<uint32_t>{}, DataType::uint32_t, {2, 8, 8, 8}}};
