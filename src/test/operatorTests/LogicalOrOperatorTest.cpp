...
// TEST HASH 9076050500677042898
TEST(TOSA2SPIRV_OPERATOR, LogicalOrOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::LogicalOr;
const std::vector<Tensor> inputs {{DataType::bool_t, {1, 1, 1, 1}}, {DataType::bool_t, {4, 6, 8, 10}}};
...
const auto& graphRes = graph.AddLogicalOrOperator(input1, input2, output1);
