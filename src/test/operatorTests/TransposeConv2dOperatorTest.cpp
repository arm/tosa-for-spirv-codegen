...
// TEST HASH 10532526890837478739
TEST(TOSA_FOR_SPIRV_CODEGEN_OPERATOR, TransposeConv2dOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::TransposeConv2d;
const std::vector<Attribute> inputs {{std::initializer_list<uint32_t>{}, DataType::uint8_t, {1, 18, 19, 16}}, {std::initializer_list<uint32_t>{}, DataType::uint8_t, {3, 2, 2, 16}}, {std::initializer_list<uint32_t>{17, 4294967269, 4294967288}, DataType::uint32_t, {3}}, {std::initializer_list<uint32_t>{0}, DataType::uint8_t, {1}}, {std::initializer_list<uint32_t>{249}, DataType::uint8_t, {1}}};
...
const auto& graphRes = graph.AddTransposeConv2dOperator(input1, input2, input3, input4, input5, attribute1, attribute2, attribute3, attribute4, output1);
