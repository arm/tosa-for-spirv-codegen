...
// TEST HASH 9308104724826342863
TEST(TOSA2SPIRV_OPERATOR, SigmoidOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::Sigmoid;
const std::vector<Tensor> inputs {{DataType::float32_t, {1}}};
...
const auto& graphRes = graph.AddSigmoidOperator(input1, output1);
