...
// TEST HASH 11254615635773311085
TEST(TOSA2SPIRV_OPERATOR, PowOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::Pow;
const std::vector<Tensor> inputs {{DataType::float32_t, {20}}};
const std::vector<Tensor> graphConstants {{DataType::float32_t, {20}}};
...
const auto& graphRes = graph.AddPowOperator(input1, graphConstInput1, output1);
