...
// TEST HASH 839678142173425304
TEST(TOSA2SPIRV_OPERATOR, TanhOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::Tanh;
...
const auto& graphRes = graph.AddTanhOperator(input1, output1);
