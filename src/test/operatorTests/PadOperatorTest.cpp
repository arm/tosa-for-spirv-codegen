...
// TEST HASH 11565719327613277050
TEST(TOSA2SPIRV_OPERATOR, PadOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::Pad;
const std::vector<Tensor> inputs {{DataType::uint8_t, {1, 112, 112, 64}}};
const std::vector<Tensor> graphConstants {};
const std::vector<Attribute> tensorConstants {{std::initializer_list<uint32_t>{0, 0, 1, 0, 1, 0, 0, 0}, DataType::uint32_t, {8}}, {std::initializer_list<uint32_t>{252}, DataType::uint8_t, {1}}};
...
const auto& graphRes = graph.AddPadOperator(input1, tensorConstInput1, tensorConstInput2, output1);
