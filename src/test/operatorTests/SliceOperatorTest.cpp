...
// TEST HASH 1544536187649328701
TEST(TOSA2SPIRV_OPERATOR, SliceOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::Slice;
const std::vector<Tensor> inputs {{DataType::uint8_t, {1, 540, 960, 11}}};
const std::vector<Tensor> graphConstants {};
const std::vector<Attribute> tensorConstants {{std::initializer_list<uint32_t>{0, 0, 0, 0}, DataType::uint32_t, {4}}, {std::initializer_list<uint32_t>{1, 540, 960, 7}, DataType::uint32_t, {4}}};
const std::vector<Tensor> outputs {{DataType::uint8_t, {1, 540, 960, 7}}};
...
const auto& graphRes = graph.AddSliceOperator(input1, tensorConstInput1, tensorConstInput2, output1);
