...
// TEST HASH 12570756865248386203
TEST(TOSA2SPIRV_OPERATOR, BitwiseAndOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::BitwiseAnd;
const std::vector<Tensor> inputs {{DataType::uint8_t, {1, 8, 8, 8}}, {DataType::uint8_t, {1, 8, 8, 8}}};
...
const auto& graphRes = graph.AddBitwiseAndOperator(input1, input2, output1);
