...
// TEST HASH 2995388688436908108
TEST(TOSA_FOR_SPIRV_CODEGEN_OPERATOR, RsqrtOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::Rsqrt;
const std::vector<Attribute> inputs {{std::initializer_list<uint32_t>{1}, DataType::float32_t, {1}}};
...
const auto& graphRes = graph.AddRsqrtOperator(input1, output1);
