...
// TEST HASH 10517104678904019564
TEST(TOSA_FOR_SPIRV_CODEGEN_OPERATOR, BitwiseOrOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::BitwiseOr;
const std::vector<Attribute> inputs {{std::initializer_list<uint32_t>{}, DataType::uint16_t, {67, 12}}, {std::initializer_list<uint32_t>{}, DataType::uint16_t, {67, 12}}};
