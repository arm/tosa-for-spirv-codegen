...
// TEST HASH 255840542720148890
TEST(TOSA_FOR_SPIRV_CODEGEN_OPERATOR, ArithmeticRightShiftOperatorTest0)
{
...
const auto& graphRes = graph.AddArithmeticRightShiftOperator(input1, input2, attribute1, output1);
