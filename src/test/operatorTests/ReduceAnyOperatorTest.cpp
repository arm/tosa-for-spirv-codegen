...
// TEST HASH 3465748566076994388
TEST(TOSA_FOR_SPIRV_CODEGEN_OPERATOR, ReduceAnyOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::ReduceAny;
const std::vector<Attribute> inputs {{std::initializer_list<uint32_t>{}, DataType::bool_t, {31}}};
