...
// TEST HASH 3586080845075810954
TEST(TOSA2SPIRV_OPERATOR, MulOperatorTest0)
{
...
const std::vector<Attribute> tensorConstants {{std::initializer_list<uint32_t>{0}, DataType::uint8_t, {1}}};
...
const auto& graphRes = graph.AddMulOperator(input1, graphConstInput1, tensorConstInput1, output1);
