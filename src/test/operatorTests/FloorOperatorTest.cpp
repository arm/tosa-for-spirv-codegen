...
// TEST HASH 13490833246566532061
TEST(TOSA2SPIRV_OPERATOR, FloorOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::Floor;
...
const auto& graphRes = graph.AddFloorOperator(input1, output1);
