...
// TEST HASH 1361788608098322337
TEST(TOSA_FOR_SPIRV_CODEGEN_OPERATOR, GreaterEqualOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::GreaterEqual;
const std::vector<Attribute> inputs {{std::initializer_list<uint32_t>{}, DataType::uint32_t, {1, 720, 1280, 16}}, {std::initializer_list<uint32_t>{}, DataType::uint32_t, {1, 1, 1, 1}}};
...
const auto& graphRes = graph.AddGreaterEqualOperator(input1, input2, output1);
