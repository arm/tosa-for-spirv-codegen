...
// TEST HASH 9845421832519208135
TEST(TOSA_FOR_SPIRV_CODEGEN_OPERATOR, RescaleOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::Rescale;
const std::vector<Attribute> inputs {{std::initializer_list<uint32_t>{}, DataType::uint32_t, {1, 540, 960, 8}}, {std::initializer_list<uint32_t>{1073741824}, DataType::uint32_t, {1}}, {std::initializer_list<uint32_t>{30}, DataType::uint8_t, {1}}, {std::initializer_list<uint32_t>{0}, DataType::uint32_t, {1}}, {std::initializer_list<uint32_t>{186}, DataType::uint8_t, {1}}};
...
const auto& graphRes = graph.AddRescaleOperator(input1, input2, input3, input4, input5, attribute1, attribute2, attribute3, attribute4, attribute5, output1);
