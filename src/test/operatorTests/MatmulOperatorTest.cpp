...
// TEST HASH 15709244863145797117
TEST(TOSA_FOR_SPIRV_CODEGEN_OPERATOR, MatmulOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::Matmul;
const std::vector<Attribute> inputs {{std::initializer_list<uint32_t>{}, DataType::uint8_t, {3, 197, 64}}, {std::initializer_list<uint32_t>{}, DataType::uint8_t, {3, 64, 197}}, {std::initializer_list<uint32_t>{255}, DataType::uint8_t, {1}}, {std::initializer_list<uint32_t>{0}, DataType::uint8_t, {1}}};
...
const auto& graphRes = graph.AddMatmulOperator(input1, input2, input3, input4, output1);
