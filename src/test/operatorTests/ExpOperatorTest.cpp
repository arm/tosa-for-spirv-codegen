...
// TEST HASH 18001592241473856699
TEST(TOSA2SPIRV_OPERATOR, ExpOperatorTest0)
{
// Operator Definition, separated for reuse in the test fixture
const OperatorEnum op = OperatorEnum::Exp;
...
const auto& graphRes = graph.AddExpOperator(input1, output1);
