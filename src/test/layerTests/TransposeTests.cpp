...
TEST(TOSA2SPIRV_LAYERS, Transpose)
{
    ...
    auto perms_val = Tensor::ConvertInt32tToUint32t({1, 1, 1, 1});
    auto perms = Tensor::CreateAttribute(DataType::int32_t,
    ...
    graph->AddTransposeOperator(input1,
                                perms,
                                output);
