...
TEST(TOSA2SPIRV_LAYERS, Dim)
{
    ...
    spirvwriter::CheckInputTensor({1, 1, 1, 1}, DataType::bool_t, "DIM", outputStr);
    spirvwriter::CheckConstant(DataType::int32_t, "DIM", outputStr, 1, 0);
    spirvwriter::CheckConstant(DataType::int32_t, "DIM", outputStr, 1, 1);
