...
TEST(TOSA2SPIRV_LAYERS, Scatter)
{
    auto module = Module::Create();
    auto graph = module->AddGraph();

    auto values_in = Tensor::CreateInput(DataType::int8_t,
                                         std::vector<unsigned int>{ 1,1,1,1 },
                                         module,
                                         "values_in");

    auto indices = Tensor::CreateInput(DataType::int32_t,
                                       std::vector<unsigned int>{ 1,1,1,1 },
                                       module,
                                       "indices");
    ...
    auto values_out = Tensor::CreateOutput(DataType::int8_t,
                                           std::vector<unsigned int>{ 1,1,1,1 },
                                           module,
                                           "values_out");
    ...
    graph->AddScatterOperator(values_in,
                              indices,
                              input,
                              values_out);
