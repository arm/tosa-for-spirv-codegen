...
By default, the build will also produce a utility executable `build/spirv2tosatool/spirv2tosaTool`.
...
```bash
./build/spirv2tosatool/spirv2tosaTool <path_to_spirv_text_file> <action> [options]
```
