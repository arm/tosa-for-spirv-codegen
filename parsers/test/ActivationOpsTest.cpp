...
TEST(TOSA2SPIRV_PARSER, Clamp)
{
    ...
    TosaSerializationBasicBlock block("clamp", "main", std::move(ops), std::move(tensors), {inputName}, {outputName});
...
TEST(TOSA2SPIRV_PARSER, Erf)
{
    ...
    // Create a tosa single-op basic block
    // The raw pointers of operators and tensors will be deleted by the destructor of the block
    TosaSerializationBasicBlock block("erf", "main", std::move(ops), std::move(tensors), {inputName}, {outputName});
...
TEST(TOSA2SPIRV_PARSER, Sigmoid)
{
    ...
    // Create a tosa single-op basic block
    // The raw pointers of operators and tensors will be deleted by the destructor of the block
    TosaSerializationBasicBlock block("sigmoid", "main", std::move(ops), std::move(tensors), {inputName}, {outputName});
...
TEST(TOSA2SPIRV_PARSER, Tanh)
{
    ...
    // Create a tosa single-op basic block
    // The raw pointers of operators and tensors will be deleted by the destructor of the block
    TosaSerializationBasicBlock block("tanh", "main", std::move(ops), std::move(tensors), {inputName}, {outputName});
